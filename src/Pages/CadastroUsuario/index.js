                ...
                <Formulario>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="inputNome">
                            ...
                            {/* INPUT NOME */}
                            <input className="input1" id="nome" type="text" placeholder="Nome" required onChange={(event) => setNome(event.target.value)} />

                            {/* INPUT SOBRENOME */}
                            <input className="input2" id="sobrenome" type="text" placeholder="Sobrenome" required onChange={(event) => setSobrenome(event.target.value)} />
                        </div>

                        {/* INPUT CPF */}
                        <input id="cpf" type="text" placeholder="CPF" required onChange={(event) => setCpf(event.target.value)} />

                        {/* INPUT EMAIL */}
                        <input id="email" type="text" placeholder="E-mail" required onChange={(event) => setEmail(event.target.value)} />

                        {/* INPUT SENHA */}
                        <input id="senha" type="password" placeholder="Senha" required onChange={(event) => setSenha(event.target.value)} />

                        {/* INPUT TIPO DE USUARIO*/}
                        <Select>
                            <select id="disciplinas" defaultValue="Tipo de Usuário" onChange={(event) => setTipoUsuario(event.target.value)}  >
